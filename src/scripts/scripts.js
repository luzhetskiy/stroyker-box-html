...
radioButtons.forEach(function (btn) {
  btn.addEventListener("change", function () {
    ...
    choices.forEach(function (choice) {
      if (choice.classList.contains(clicked.id) ||
...
(function ($) {
  ...
  customSelect.each(function () {
    ...
    customSelect = '<div class="dropdown-container"><div class="dropdown-select entypo-down-open-big"><svg class="icon"><use xlink:href="#tab-arrow"></use></svg><span>' + startingOption + '</span></div><ul class="dropdown-select-ul" data-role="' + listID + '">' + theOptions + '</ul></div> <!-- .custom-select-wrapper -->';
...
$(keypressSliders).each(function (index, keypressSlider) {
  let field_name = $(keypressSlider).data('name');
